...
<form class="formulaire container mt-3 d-flex flex-column w-25" action="{{route('portfolios.store')}}" enctype="multipart/form-data" method="post">
    @csrf
    Titre Img: <input class="my-2 " type="text" value="" name="titreimg">
    Sous-titre Img: <input class="my-2" type="text" value="" name="categorie">
    Image: <input class="mt-2" type="file" value="" name="img">
